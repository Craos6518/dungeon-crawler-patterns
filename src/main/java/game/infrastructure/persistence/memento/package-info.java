 ...
 * 
 * Componentes:
 * - {@link game.application.state.GameMemento} - Memento (estado inmutable)
 * - {@link game.infrastructure.persistence.memento.GameOriginator} - Originator (crea y restaura mementos)
 * - {@link game.infrastructure.persistence.memento.GameCaretaker} - Caretaker (gestiona mementos)
 * 
 * Roles:
