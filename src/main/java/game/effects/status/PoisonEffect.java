...
/**
 * Decorador concreto que aplica el efecto de Envenenamiento.
 * El personaje recibe daño al inicio de cada turno.
 */
public class PoisonEffect extends CharacterDecorator {
    private final int danoPorTurno;
    private int turnosRestantes;

    public PoisonEffect(Personaje personaje, int danoPorTurno, int duracion) {
        super(personaje);
    ...
    public String getDescripcionEfecto() {
        return String.format("⚗️ Envenenado (-%d HP por turno, %d turnos restantes)", 
    ...
    public String getNombre() {
        if (efectoActivo()) {
            return personajeDecorado.getNombre() + " [Envenenado]";
        }
